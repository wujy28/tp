...
public class AssignCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Assigns a patient identified "
            + "by the IC number to a hospital department. "
            ...
            + "Example: " + COMMAND_WORD + " " + PREFIX_IC_NUMBER + "T0372683C " + PREFIX_DEPARTMENT + "cardiology";
    ...
    public static final String MESSAGE_INVALID_DEPARTMENT = "Department: %s does not exist.\n"
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Patient patientToAssign = model.getPatient(icNumber, lastShownList);
        Patient assignedPatient = createAssignedPatient(patientToAssign, department);

        if (patientToAssign.equals(assignedPatient)) {
            throw new CommandException(String.format(MESSAGE_SAME_DEPARTMENT,
                    patientToAssign.getName(), this.department));
        }
    ...
    public boolean equals(Object other) {
        ...
        return icNumber.equals(otherAssignCommand.icNumber) && department.equals(
                otherAssignCommand.department);
    }
