...
import static seedu.address.logic.Messages.MESSAGE_INVALID_PATIENT_IC;
...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsParseException() {
        System.out.println(MESSAGE_INVALID_PATIENT_IC);
        String deleteCommand = "delete i/S1234";
        assertParseException(deleteCommand, MESSAGE_INVALID_PATIENT_IC);
    }
    ...
    private void assertCommandSuccess(String inputCommand, String expectedMessage,
            Model expectedModel) throws CommandException, ParseException, PatientWithFieldNotFoundException {
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addCommand = AddCommand.COMMAND_WORD + NAME_DESC_AMY + IC_NUMBER_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + GENDER_DESC_AMY + BIRTHDAY_DESC_AMY + PRIORITY_DESC_AMY;
