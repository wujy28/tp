...
public class TypicalPatients {
    ...
    public static final Patient BENSON = new PatientBuilder()
            ...
            .withGender("male")
            .withBirthday("17/03/1987")
            .withIcNumber("S2091742P")
            .withPhone("98765432")
    ...
    public static final Patient CARL = new PatientBuilder()
            ...
            .withPhone("95352563")
            .withGender("male")
            .withBirthday("08/06/1997")
            .withIcNumber("S2780456R")
    ...
    public static final Patient DANIEL = new PatientBuilder()
            ...
            .withPhone("87652533")
            .withGender("male")
            .withBirthday("29/01/2001")
            .withIcNumber("T0163826D")
    ...
    public static final Patient ELLE = new PatientBuilder()
            ...
            .withPhone("9482224")
            .withGender("female")
            .withBirthday("12/11/1995")
            .withIcNumber("S1839267A")
    ...
    public static final Patient FIONA = new PatientBuilder()
            ...
            .withGender("female")
            .withBirthday("29/06/1982")
            .withIcNumber("S3729462N")
    ...
    public static final Patient GEORGE = new PatientBuilder()
            ...
            .withPhone("9482442")
            .withGender("male")
            .withBirthday("03/07/1997")
            .withIcNumber("S4839258F")
    ...
    public static final Patient HOON = new PatientBuilder()
            ...
            .withPhone("8482424")
            .withGender("male")
            .withBirthday("07/04/2002")
            .withIcNumber("T0247382S")
    ...
    public static final Patient IDA = new PatientBuilder()
            ...
            .withPhone("8482131")
            .withGender("female")
            .withBirthday("29/04/1984")
            .withIcNumber("S5729346L")
